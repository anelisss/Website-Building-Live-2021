...
new Vue({
    ...
    data: {
        productsArray: [{
            ...
            "deion": "What if you pursued perfection like you pursued the sun’s rays: every day but getting too close will get you in trouble?",
            "price": "125",
        ...
        },
        {
            ...
            "deion": "What if you took the risk as calculated as someone trying to get away with a crime?",
            "price": "99",
        ...
        },
        {
            ...
            "deion": "What if you opened your mind for new opportunities as a 3-year-old is open for learning?",
            "price": "95",
        ...
        },
        {
            ...
            "deion": "What if you just focused your entire energy the way a laser focuses its energy to cut through steel?",
            "price": "68",
        ...
        },
        {
            ...
            "deion": "What if you though out of the box, as open and enthusiastic as a child unwrapping presents on Christmas day?",
            "price": "65",
        ...
        },
        {
            ...
            "deion": "What if you believed in yourself the way Zlatan Ibrahimovic believes in his powers?",
            "price": "65",
        ...
        },
        {
            ...
            "deion": "What if you worked so hard for your dreams and goals like the Egyptians used to work for their pyramids?",
            "price": "60",
    ...
    computed: {
        ...
        productsCount() {
            return this.filter.length ? this.filter.length + " " + "Product(s)" : "No products"
        },
        totalPriceCart() {
            return this.cartValue.reduce((incr, item) => incr + Number(item.price), 0)
        }
    },
